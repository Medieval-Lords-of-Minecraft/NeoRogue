...
public class Pin extends Equipment {
	...
	public void setupItem() {
		item = createItem(Material.REDSTONE,
				"On cast, " + GlossaryTag.DASH.tag(this) + " forward, dragging all enemies you contact along with you and slowing them " + DescUtil.duration(5) + ". If you hit a wall,"
				+ " deal " + DescUtil.val(damage) + " " + GlossaryTag.BLUNT.tag(this) + " damage to them and reduce their damage by "
