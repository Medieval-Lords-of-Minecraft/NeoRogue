...
public class WindSlash extends Equipment {
	...
	public WindSlash(boolean isUpgraded) {
		super(ID, "Wind Slash", isUpgraded, Rarity.UNCOMMON, EquipmentClass.WARRIOR,
				EquipmentType.ABILITY, EquipmentProperties.ofUsable(0, 20, 8, 8));
	...
	public void setupItem() {
		item = createItem(Material.STRING,
				"On cast, fire " + DescUtil.val(amount) + " projectiles in a cone in front of you that deal "
						+ DescUtil.val(damage) + " " + GlossaryTag.SLASHING.tag(this) + " damage.");
	}
