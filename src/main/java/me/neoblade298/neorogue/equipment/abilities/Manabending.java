...
public class Manabending extends Equipment {
	...
	public void setupItem() {
		item = createItem(Material.LIGHT_BLUE_GLAZED_TERRACOTTA,
				GlossaryTag.PASSIVE.tag(this) + ". Increase all " + GlossaryTag.MAGICAL.tag(this) + " damage by " + DescUtil.val(damage) + ". " +
				"Applying any negative status effects increases your mana by " + DescUtil.val(regen) + ", up to once per second.");
	}
}
