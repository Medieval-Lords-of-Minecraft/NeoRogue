...
public class StormweaversPromise extends Equipment implements Power {
	...
	public void setupItem() {
		item = createItem(Material.LIGHTNING_ROD,
				GlossaryTag.POWER.tag(this) + ". Activates after dealing projectile damage " + DescUtil.white(8) + " times while above " + DescUtil.white("50%") + " stamina. Gain " + GlossaryTag.SHIELDS.tag(this, shields, true) + " [<white>3s</white>] whenever you deal projectile damage. " +
