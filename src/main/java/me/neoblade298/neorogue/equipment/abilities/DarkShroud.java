...
public class DarkShroud extends Equipment implements Power {
	...
	public void setupItem() {
		item = createItem(Material.PHANTOM_MEMBRANE,
				GlossaryTag.PASSIVE.tag(this) + " " + GlossaryTag.POWER.tag(this) + ". Activates after launching " + DescUtil.val(3) + " projectile groups. Your projectiles deal an additional " + GlossaryTag.DARK.tag(this, damage) + " damage.");
	}
}
