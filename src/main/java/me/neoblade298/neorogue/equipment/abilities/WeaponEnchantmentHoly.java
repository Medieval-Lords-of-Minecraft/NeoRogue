...
public class WeaponEnchantmentHoly extends Equipment {
	...
	public WeaponEnchantmentHoly(boolean isUpgraded) {
		super(ID, "Weapon Enchantment: Holy", isUpgraded, Rarity.COMMON, EquipmentClass.WARRIOR,
	...
	public void setupItem() {
		item = createItem(Material.NETHER_STAR,
				GlossaryTag.PASSIVE.tag(this) + ". Your left clicks fire a projectile that deals " + GlossaryTag.LIGHT.tag(this, damage)
				+ " damage and applies " + GlossaryTag.SANCTIFIED.tag(this, sanct) + ".");
	}
