...
public class AurorBadge extends Artifact {
	...
	public void initialize(PlayerFightData data, ArtifactInstance ai) {
		...
		data.addTrigger(id, Trigger.PRE_BASIC_ATTACK, (pdata, in) -> {
			...
			if (am.getTime() + 3000 < System.currentTimeMillis()) {
				ev.getMeta().addDamageBuff(DamageBuffType.of(DamageCategory.DIRECT), Buff.multiplier(data, damage, StatTracker.damageBuffAlly(am.getId(), this)));
			}
	...
	public void setupItem() {
		item = createItem(Material.SKULL_BANNER_PATTERN, 
				"Upon dealing a basic attack, if your last basic attack was over " + DescUtil.val(3) + " seconds ago, your " +
				"basic attack damage is increased by " + DescUtil.val((int) (damage * 100) + "%") + ".");
	}
}
