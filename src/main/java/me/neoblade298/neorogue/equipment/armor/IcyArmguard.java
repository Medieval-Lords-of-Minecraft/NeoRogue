...
public class IcyArmguard extends Equipment {
	...
	public void setupItem() {
		item = createItem(Material.RABBIT_HIDE, "Decrease all " + GlossaryTag.MAGICAL.tag(this) + " damage received by " + DescUtil.val(damageReduction) + ". " +
				"Also grants " + GlossaryTag.SHIELDS.tag(this, shields) + " [<white>5s</white>] for every " +
				GlossaryTag.FROST.tag(this, thres) + " you apply.");
	}
}
