...
public class MercurialGloves extends Equipment {
	...
	public void setupItem() {
		item = createItem(Material.LEATHER,
				GlossaryTag.PASSIVE.tag(this) + ". Save the location of your last " + DescUtil.val(maxLocations) + " basic attacks. " +
				"On left click, fire your current ammunition from those locations toward you. " +
				"All projectiles count as basic attacks and deal " + GlossaryTag.PIERCING.tag(this, damage) + " damage.");
	}
}
