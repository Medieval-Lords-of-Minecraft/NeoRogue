...
public class AllMinibossesAchievement extends ObjectiveAchievement {
	private final String id;
	private final Component displayName;
	private final Material material;
	private final RegionType region;

	public AllMinibossesAchievement(String id, Component displayName, Material material, RegionType region) {
		this.id = id;
	...
	public List<String> getObjectiveIds() {
		ArrayList<MapPiece> pieces = Map.getMinibossPieces().get(region);
