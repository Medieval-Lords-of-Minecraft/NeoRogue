...
public enum FightScore {
	D(0, 9999, 5, 0.0, 15, null, new Color(255, 140, 90)),
	C(1, 50, 10, 0.0, 30, D, new Color(255, 178, 52)),
	B(2, 45, 15, 0.0, 90, C, new Color(255, 217, 52)),
	A(3, 40, 20, 0.05, 120, B, new Color(173, 214, 51)),
	S(4, 80, 25, 0.1, 135, A, new Color(160, 193, 90));
