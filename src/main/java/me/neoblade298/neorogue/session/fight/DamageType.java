...
public enum DamageType {
	SLASHING("Slashing", "<yellow>Slashing</yellow>",
		EnumSet.of(DamageCategory.SLASHING, DamageCategory.PHYSICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	PIERCING("Piercing", "<red>Piercing</red>",
		EnumSet.of(DamageCategory.PIERCING, DamageCategory.PHYSICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	BLUNT("Blunt", "<gold>Blunt</gold>",
		EnumSet.of(DamageCategory.BLUNT, DamageCategory.PHYSICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	FIRE("Fire", "<dark_red>Fire</dark_red>",
		EnumSet.of(DamageCategory.FIRE, DamageCategory.MAGICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	ICE("Ice", "<blue>Ice</blue>",
		EnumSet.of(DamageCategory.ICE, DamageCategory.MAGICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	LIGHTNING("Lightning", "<yellow>Lightning</yellow>",
		EnumSet.of(DamageCategory.LIGHTNING, DamageCategory.MAGICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	EARTHEN("Earthen", "<dark_green>Earthen</dark_green>",
		EnumSet.of(DamageCategory.EARTHEN, DamageCategory.MAGICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	DARK("Dark", "<dark_purple>Dark</dark_purple>",
		EnumSet.of(DamageCategory.DARK, DamageCategory.MAGICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	LIGHT("Light", "<white>Light</white>",
		EnumSet.of(DamageCategory.LIGHT, DamageCategory.MAGICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	...
	REND("Rend", StatusType.REND.tag,
		EnumSet.of(DamageCategory.PIERCING, DamageCategory.PHYSICAL, DamageCategory.DIRECT, DamageCategory.STATUS, DamageCategory.ALL)),
	ELECTRIFIED("Electrified", StatusType.ELECTRIFIED.tag,
		EnumSet.of(DamageCategory.STATUS, DamageCategory.MAGICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
	THORNS("Thorns", StatusType.THORNS.tag,
		EnumSet.of(DamageCategory.STATUS, DamageCategory.PHYSICAL, DamageCategory.DIRECT, DamageCategory.ALL)),
