...
public enum Trigger {
	...
	PRE_DEAL_DAMAGE, DEAL_DAMAGE, DEAL_DAMAGE_MULTIPLE, WIN_FIGHT, PRE_APPLY_STATUS, APPLY_STATUS,
	PRE_RECEIVE_STATUS, RECEIVE_STATUS, RECEIVE_POTION, PRE_LAUNCH_PROJECTILE_GROUP, LAUNCH_PROJECTILE_GROUP, LAY_TRAP,
	DEACTIVATE_TRAP, CREATE_RIFT, REMOVE_RIFT, PRE_GRANT_SHIELDS, GRANT_SHIELDS, FALL_DAMAGE, // Cancellable
	PRE_RECEIVE_SHIELDS, RECEIVE_SHIELDS, CHANGE_AMMUNITION, THROW_TRIDENT, USE_CONSUMABLE, TOGGLE_SPRINT, TOGGLE_CROUCH, PRE_RECEIVE_DAMAGE, // Cancellable
	RECEIVE_DAMAGE, DASH,
	...
	STAMINA_CHANGE, MANA_CHANGE, PRE_KILL, KILL, KILL_GLOBAL, // Triggers when ANY player kills a mob; currently just used for
													// Brand
	PRE_ACTIVATE_POWER, // Cancellable
	ACTIVATE_POWER;

	public static Trigger getFromHotbarSlot(int hotbar) {
		switch (hotbar) {
		case 0:
			return Trigger.HOTBAR_1;
		case 1:
			return Trigger.HOTBAR_2;
		case 2:
			return Trigger.HOTBAR_3;
		case 3:
			return Trigger.HOTBAR_4;
		case 4:
			return Trigger.HOTBAR_5;
		case 5:
			return Trigger.HOTBAR_6;
		case 6:
			return Trigger.HOTBAR_7;
		case 7:
			return Trigger.HOTBAR_8;
		case 8:
			return Trigger.HOTBAR_9;
		default:
			return null;
		}
	}
