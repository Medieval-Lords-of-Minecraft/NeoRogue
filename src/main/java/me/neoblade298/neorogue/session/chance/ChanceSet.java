...
import me.neoblade298.neorogue.session.chance.builtin.FrozenForgeChance;
import me.neoblade298.neorogue.session.chance.builtin.GamblingDenChance;
...
import me.neoblade298.neorogue.session.chance.builtin.SageOfTheMountainChance;
...
public class ChanceSet {
	...
	public static void load() {
		...
		new FrozenForgeChance();
		new GamblingDenChance();
		new GreedChance();
		new LabChance();
		new LostRelicChance();
		new ManaPoolChance();
