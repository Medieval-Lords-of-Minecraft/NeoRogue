...
public class CmdAdminTestMW extends Subcommand {
	public CmdAdminTestMW(String key, String desc, String perm, SubcommandRunner runner) {
	...
	public void run(CommandSender s, String[] args) {
		...
		NeoRogue.debugInitialize(host, others, EquipmentClass.WARRIOR, RegionType.MEADOWOOD);
	}
}
