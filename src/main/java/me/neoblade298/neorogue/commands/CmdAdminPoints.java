...
public class CmdAdminPoints extends Subcommand {
	public CmdAdminPoints(String key, String desc, String perm, SubcommandRunner runner) {
	...
	public void run(CommandSender s, String[] args) {
		...
		pdata.addPoints(ec, amount);
		String category = ec == null ? "Global" : ec.getDisplay();
		Util.msgRaw(s, "<green>Added " + amount + " " + category + " points to " + p.getName()
				+ " (now " + pdata.getPoints(ec) + ")");
	}
