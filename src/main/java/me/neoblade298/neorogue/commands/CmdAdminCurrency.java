...
public class CmdAdminCurrency extends Subcommand {
	public CmdAdminCurrency(String key, String desc, String perm, SubcommandRunner runner) {
	...
	public void run(CommandSender s, String[] args) {
		...
		sess.getParty().get(p.getUniqueId()).addCurrency(Integer.parseInt(args[0]));
	}
}
