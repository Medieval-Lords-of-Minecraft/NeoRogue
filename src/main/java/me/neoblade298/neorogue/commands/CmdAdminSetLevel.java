...
public class CmdAdminSetLevel extends Subcommand {
	public CmdAdminSetLevel(String key, String desc, String perm, SubcommandRunner runner) {
		...
		classTab.add("MAGE");
		classTab.add("ARCHER");
		args.add(new Arg("level"), new Arg("class", false).setTabOptions(classTab), new Arg("player", false));
