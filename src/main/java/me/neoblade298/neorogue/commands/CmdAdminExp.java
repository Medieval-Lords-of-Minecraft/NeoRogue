...
public class CmdAdminExp extends Subcommand {
	public CmdAdminExp(String key, String desc, String perm, SubcommandRunner runner) {
	...
	public void run(CommandSender s, String[] args) {
		...
		Util.msg(s, "<green>Added " + amount + " " + category + " exp to " + p.getName());
	}
