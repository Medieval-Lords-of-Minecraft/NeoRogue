...
public class SapphirePendant extends Artifact {
	private static final String ID = "sapphirePendant";
	...
	public SapphirePendant() {
		super(ID, "Sapphire Pendant", Rarity.UNCOMMON, EquipmentClass.MAGE);
	}
