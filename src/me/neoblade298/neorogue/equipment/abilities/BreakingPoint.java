...
public class BreakingPoint extends Equipment {
			...
			if (ev.isSneaking()) {
				...
				task = new BukkitRunnable() {
					public void run() {
						...
						Util.msgRaw(p, Component.text("").append(hoverable).append(Component.text(" was refreshed", NamedTextColor.GRAY)));
					}
	...
	public void setupItem() {
		item = createItem(Material.BRICK,
				"Passive. This ability holds up to " + GlossaryTag.SHIELDS.tag(this, shields, false) + ". While crouching, gain this shield. " +
