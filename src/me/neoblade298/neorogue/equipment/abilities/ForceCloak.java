...
public class ForceCloak extends Equipment {
	...
	public ForceCloak(boolean isUpgraded) {
		super(ID, "Force Cloak", isUpgraded, Rarity.COMMON, EquipmentClass.MAGE,
				EquipmentType.ABILITY, EquipmentProperties.ofUsable(isUpgraded ? 25 : 35, 0, isUpgraded ? 15 : 20, 0));
	...
	public void setupItem() {
		item = createItem(Material.SHIELD,
				"On cast, apply " + GlossaryTag.PROTECT.tag(this, 1, false) + " and " + GlossaryTag.SHELL.tag(this, 1, false) + ".");
	}
}
