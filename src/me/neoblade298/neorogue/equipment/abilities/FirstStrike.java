...
public class FirstStrike extends Equipment {
	...
	public void setupItem() {
		item = createItem(Material.IRON_SWORD,
				"On cast, damage the nearest enemy for " + GlossaryTag.PIERCING.tag(this, damage, true) + " and dash"
				+ " forward. Gaining " + GlossaryTag.STEALTH.tag(this) + " or " + GlossaryTag.EVADE.tag(this) + " refreshes the cooldown.");
	}
