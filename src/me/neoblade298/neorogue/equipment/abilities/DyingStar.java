...
public class DyingStar extends Equipment {
	...
	public void setupItem() {
		item = createItem(Material.NETHER_STAR,
				GlossaryTag.POWER.tag(this) + ". Activates after creating " + DescUtil.white(2) + " " + GlossaryTag.RIFT.tag(this) + "s. Create a " + GlossaryTag.RIFT.tag(this) + ". Afterwards, when any " + GlossaryTag.RIFT.tag(this) +
