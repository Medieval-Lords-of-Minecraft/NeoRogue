...
public enum GlossaryTag implements GlossaryIcon {
	...
	POISON(Material.GREEN_DYE, StatusType.POISON.tag,
			"Deals 0.2 poison damage per stack applied to the affected entity every second, ignoring shields, for its entire duration. 20% of the stacks is removed every second."),
	...
	BURN(Material.BLAZE_POWDER, StatusType.BURN.tag,
			"Reduces the affected entity's resistance to fire by damage by 0.2 per stack applied. 20% of the stacks is removed every second."),
	...
	ELECTRIFIED(Material.LIGHTNING_ROD, StatusType.ELECTRIFIED.tag,
			"Whenever the affected entity casts an ability or deals damage, deal 0.2 lightning damage per stack applied to the affected entity. 20% of the stacks is removed every second."),
